...
class TestUserFunctions(unittest.TestCase):
    ...
    def test_create_user(self):
        ...
        users_db.create_user(cursor, conn, "1", "test_user", "Test", "User", "test@example.com", "1234567890", "test_user.jpg")
    ...
    def test_get_user_by_id(self):
        ...
        users_db.user = users_db.get_user_by_id(cursor, conn, user_id)
        # Add assertions to check if the expected data is returned

    def test_update_user(self):
        # Test updating user information
        user_id = 1  # Replace with an actual user ID from your database
        users_db.update_user(cursor, conn, user_id, "new_username", "New", "User", "new@example.com", "9876543210", "new_user.jpg")
    ...
    def test_delete_user(self):
        ...
        users_db.delete_user(cursor, conn, .user_id)
